...
#+BEGIN_LaTeX
\begin{center}\includegraphics[scale=0.5]{res/opening.png}\end{center}
#+END_LaTeX
\note[itemize]{
...
#+BEGIN_LaTeX
\begin{center}\includegraphics[scale=0.3]{res/remote-helper.png}\end{center}
#+END_LaTeX
\note[itemize]{
...
\end{column}
\begin{column}[c]{2cm}
\includegraphics[scale=0.4]{res/bidi.png}
\end{column}
\end{columns}
#+END_LaTeX
\note[itemize]{
...
\begin{columns}
\begin{column}[c]{4cm}
\includegraphics[scale=0.3]{res/piston.png}
\end{column}
\begin{column}[c]{6cm}
\begin{itemize}
\end{itemize}
