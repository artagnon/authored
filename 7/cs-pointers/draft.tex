...
\includegraphics[width=20mm]{png/logo.png}
\end{wrapfigure}
...
\includegraphics[width=55mm]{png/variable-pointer.png}
\end{wrapfigure}
...
\includegraphics[width=70mm]{png/layer-splitup.png}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{70mm}
\includegraphics[width=70mm]{png/simple-pointer.png}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{70mm}
\includegraphics[width=70mm]{png/dual-ar.png}
\end{wrapfigure}
