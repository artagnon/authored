...
\end{columns}
#+END_LaTeX
\note{L4::Pistachio microkernel\\
"Learning Haskell ruins you as a programmer"\\
...
\end{columns}
#+END_LaTeX
\note{Created by Simon Peyton Jones, Simon Marlow. Goes through C--}
